"""
Card image rendering and composition.

Handles all aspects of generating MTG card images including:
- CardDraw class for image composition
- Helper functions for creating card images
