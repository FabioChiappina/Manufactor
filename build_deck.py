...
from build_card import create_image_from_Card
...
def create_images_from_Deck(deck, save_path=None, skip_complete=True):
    if type(deck)!=game_elements.Deck:
        raise TypeError("Input card must be of type Deck.")
    ...
    for ci, card in enumerate(deck.cards):
        ...
        create_image_from_Card(card, save_path=save_path)
...
def main():
    ...
    # TODO
    # prepare_for_printing(card_dict, deck_folder)
